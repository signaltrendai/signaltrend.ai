...
const API_BASE =
  "https://signaltrendai-backend.gregoryvhibox.workers.dev";
...
export default function Success() {
  ...
  function connectDiscord() {
    ...
    window.location.href =
      `${API_BASE}/auth/discord/start?session_id=` +
  ...
  async function manageSubscription() {
    ...
    try {
      const res = await fetch(
        `${API_BASE}/api/create-portal-session`,
        {
          method: "POST",
          headers: {
      ...
      >
        ...
        {!loading && !error && (
          <>
            ...
            >
              Your subscription is active. Connect Discord to
              receive signals and unlock your access role.
            </p>
        ...
        >
          You can manage billing, update payment methods,
          or cancel anytime through Stripe.
        </p>
      </div>
    </div>
  );
